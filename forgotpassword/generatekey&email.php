...
$headers4="email@eax.com";         ///// Change this address within quotes to your address ///
...
\n\n
$site_url
 \n\n Thank You \n \n ","$headers")){echo "<center><font face='Verdana' size='2' ><b>THANK YOU</b> <br>Your password is posted to your emil address . Please check your mail after some time. </center>";}
...
echo $site_url;
echo $em." Your Request for login details This is in response to your request for login detailst at site_name \n \nLogin ID: ".$row->userid." \n To reset your password, please visit this link( or copy and paste this link in your browser window )\n\n\n\n".$site_url."\n\n Thank You \n \n ".$headers;
}
catch(Exception $e) {
echo $e;
}
